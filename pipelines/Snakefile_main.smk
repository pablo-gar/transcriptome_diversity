...
all_datasets_subset_gtex_noPrefix = list(set(all_datasets_subset_gtex_noPrefix).intersection(set(all_tissues_gtex)))
all_datasets_subset_gtex_noPrefix = all_datasets_subset_gtex_noPrefix + ['Cells_EBVtransformed_lymphocytes', 'Brain_Spinal_cord_cervical_c1']
...
rule all:
    input: 
       ...
       #expand(os.path.join(config['projectDir'],  'var_explained_by_transcriptome_diversity', 'pca_method', 'from_raw', '{normalization}', '{dataset}', 'var_explained.txt'), normalization=['tmm', 'tpm'], dataset=list(all_datasets)),
        ...
        #
        # Original sources 
        #expand(os.path.join(config['projectDir'], 'var_explained_by_transcriptome_diversity', 'pca_method', 'original_sources', '{dataset}', 'PC_matrix.txt'), dataset=all_datasets_original),
        #expand(os.path.join(config['projectDir'], 'var_explained_by_transcriptome_diversity', 'pca_method', 'original_sources', '{dataset}', 'PC_stats.txt'), dataset=all_datasets_original),
        #expand(os.path.join(config['projectDir'], 'var_explained_by_transcriptome_diversity', 'pca_method', 'original_sources', '{dataset}', 'cors.txt'), dataset=all_datasets_original),
        ###------------------------------------------------------------------
