...
out_prefix <- '../figures/figure_3_features_associated/2_sarantopoulou_platforms_'

p_file_individual <- paste0(out_prefix, 'individual.pdf')
p_file_platform_unt <- paste0(out_prefix, 'Platform_untreated.pdf')
p_file_platform_ILB <- paste0(out_prefix, 'Platform_treat_ILB.pdf')
p_file_platform_both <- paste0(out_prefix, 'Platform_both_treat_untreat.pdf')
p_file_read_depth <- paste0(out_prefix, 'read_depth.pdf')
p_file_read_depth_rankit <- paste0(out_prefix, 'read_depth_rankit.pdf')
...
ggsave(p_file_individual, p_individual, width=5, height=3)
ggsave(p_file_platform_unt, p_plat_unt, width=3, height=3)
ggsave(p_file_platform_ILB, p_plat_ilb, width=3, height=3)
ggsave(p_file_platform_both, p_plat_treatment, width=3.2, height=3.2)
ggsave(p_file_read_depth, p_depth, width=6, height=2.5)
ggsave(p_file_read_depth_rankit, p_depth_rankit, width=6, height=2.5)
