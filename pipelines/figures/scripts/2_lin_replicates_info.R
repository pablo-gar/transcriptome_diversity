...
transcriptome_diversity_file <- '../data/lin_tpm_transcriptome_diversity.txt'
sample_metadata_file <- '../data/lin_covariates.txt'
...
out_prefix <- '../figures/2_lin_replicates_'
...
ggsave(paste0(out_prefix, 'strains.pdf'), p_strains, width=5, height=2)
ggsave(paste0(out_prefix, 'replicates.pdf'), p_environ, width=3, height=3)
ggsave(paste0(out_prefix, 'fly_number.pdf'), p_fly, width=3, height=5)
ggsave(paste0(out_prefix, 'sex.pdf'), p_sex, width=3, height=3)
ggsave(paste0(out_prefix, 'read_depth.pdf'), p_depth, width=2.5, height=2.5)
#ggsave(paste0(out_prefix, 'read_depth_rankit.pdf'), p_depth_rankit, width=1.5, height=1,5)
ggsave(paste0(out_prefix, 'model_pvalues.pdf'), p_model_results, width=6, height=3)
ggsave(paste0(out_prefix, 'fina_combined_features.pdf'), p_final, width=5, height=2.3)
